...
class MyFrame1(wx.Frame):
    def __init__(self, parent):
        ...
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"优选外卖信息管理系统", pos=wx.DefaultPosition,
                          size=wx.Size(610, 400),
        ...
        self.m_staticText1 = wx.StaticText(self.m_panel1, wx.ID_ANY, u"店铺：", (20, 20))
        self.m_button01 = wx.Button(self.m_panel1, wx.ID_ANY, u"店铺信息", (130, 20), wx.DefaultSize,
                                    style=wx.BORDER_MASK)
        self.m_button02 = wx.Button(self.m_panel1, wx.ID_ANY, u"店铺上架", (250, 20), wx.DefaultSize,
                                    style=wx.BORDER_MASK)
        self.m_button03 = wx.Button(self.m_panel1, wx.ID_ANY, u"店铺下架", (370, 20), wx.DefaultSize,
                                    style=wx.BORDER_MASK)

        self.m_staticText2 = wx.StaticText(self.m_panel1, wx.ID_ANY, u"派送员：", (20, 90))
        self.m_button04 = wx.Button(self.m_panel1, wx.ID_ANY, u"派送员信息", (130, 90), wx.DefaultSize,
                                    style=wx.BORDER_MASK)
        self.m_button05 = wx.Button(self.m_panel1, wx.ID_ANY, u"聘请派送员", (250, 90), wx.DefaultSize,
                                    style=wx.BORDER_MASK)
        self.m_button06 = wx.Button(self.m_panel1, wx.ID_ANY, u"解雇派送员", (370, 90), wx.DefaultSize,
                                    style=wx.BORDER_MASK)

        self.m_staticText3 = wx.StaticText(self.m_panel1, wx.ID_ANY, u"客服人员：", (20, 160))
        self.m_button07 = wx.Button(self.m_panel1, wx.ID_ANY, u"客服人员信息", (130, 160), wx.DefaultSize,
                                    style=wx.BORDER_MASK)
        self.m_button08 = wx.Button(self.m_panel1, wx.ID_ANY, u"聘请客服人员", (250, 160), wx.DefaultSize,
                                    style=wx.BORDER_MASK)
        self.m_button09 = wx.Button(self.m_panel1, wx.ID_ANY, u"解雇客服人员", (370, 160), wx.DefaultSize,
                                    style=wx.BORDER_MASK)

        self.m_staticText4 = wx.StaticText(self.m_panel1, wx.ID_ANY, u"订单：", (20, 230))
        ...
        self.m_staticText5 = wx.StaticText(self.m_panel1, wx.ID_ANY, u"物流：", (20, 300))
        ...
        '''
            ...
            Button被单击发生了EVT_BUTTON事件
        '''
        self.m_button01.Bind(wx.EVT_BUTTON, MyDialog11(None).click)
        self.m_button02.Bind(wx.EVT_BUTTON, MyDialog12(None).click)
        self.m_button03.Bind(wx.EVT_BUTTON, MyDialog13(None).click)
        self.m_button04.Bind(wx.EVT_BUTTON, MyDialog21(None).click)
        self.m_button05.Bind(wx.EVT_BUTTON, MyDialog22(None).click)
        self.m_button06.Bind(wx.EVT_BUTTON, MyDialog23(None).click)
        self.m_button07.Bind(wx.EVT_BUTTON, MyDialog31(None).click)
        self.m_button08.Bind(wx.EVT_BUTTON, MyDialog32(None).click)
        self.m_button09.Bind(wx.EVT_BUTTON, MyDialog33(None).click)
        self.m_button10.Bind(wx.EVT_BUTTON, MyDialog41(None).click)
        self.m_button11.Bind(wx.EVT_BUTTON, MyDialog42(None).click)
        self.m_button12.Bind(wx.EVT_BUTTON, MyDialog43(None).click)
        self.m_button13.Bind(wx.EVT_BUTTON, MyDialog44(None).click)
        self.m_button14.Bind(wx.EVT_BUTTON, MyDialog51(None).click)
        self.m_button15.Bind(wx.EVT_BUTTON, MyDialog52(None).click)
        self.m_button16.Bind(wx.EVT_BUTTON, MyDialog53(None).click)

        # 设置按钮的背景颜色
        self.m_button01.SetBackgroundColour('#eaadea')
        self.m_button01.SetForegroundColour('black')
        self.m_button02.SetBackgroundColour('#eaadea')
        self.m_button02.SetForegroundColour('black')
        self.m_button03.SetBackgroundColour('#eaadea')
        self.m_button03.SetForegroundColour('black')

        self.m_button04.SetBackgroundColour('#db9370')
        self.m_button04.SetForegroundColour('black')
        self.m_button05.SetBackgroundColour('#db9370')
        self.m_button05.SetForegroundColour('black')
        self.m_button06.SetBackgroundColour('#db9370')
        self.m_button06.SetForegroundColour('black')

        self.m_button07.SetBackgroundColour('#99cc32')
        self.m_button07.SetForegroundColour('black')
        self.m_button08.SetBackgroundColour('#99cc32')
        self.m_button08.SetForegroundColour('black')
        self.m_button09.SetBackgroundColour('#99cc32')
        self.m_button09.SetForegroundColour('black')

        self.m_button10.SetBackgroundColour('#bfd8d8')
        self.m_button10.SetForegroundColour('black')
        self.m_button11.SetBackgroundColour('#bfd8d8')
        self.m_button11.SetForegroundColour('black')
        self.m_button12.SetBackgroundColour('#bfd8d8')
        self.m_button12.SetForegroundColour('black')
        self.m_button13.SetBackgroundColour('#bfd8d8')
        self.m_button13.SetForegroundColour('black')
...
class MyDialog11(wx.Dialog):
    ...
    def click(self, event):
        ...
        conn = pymysql.connect(host='127.0.0.1', port=3306, user='root', passwd='123456', db='project', charset='utf8')
        cursor = conn.cursor()
        try:
